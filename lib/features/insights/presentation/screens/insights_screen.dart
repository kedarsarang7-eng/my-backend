    ...
    return DesktopContentContainer(
      ...
      child: Column(
        ...
        children: [
          ...
          _SectionHeader(
              title: "Smart Assistant", isDark: isDark, icon: Icons.psychology),
          const SizedBox(height: 12),
          ...
          return Column(
            children: [
              Row(
                ...
                children: [
                  _StockPill(
                      label: 'In Stock', count: inStock, color: Colors.green),
                  _StockPill(
                      label: 'Low Stock',
                      count: lowStock,
                      color: Colors.orange),
