                ...
                onPressed: () {
                  if (formKey.currentState!.validate()) {
                    ...
                    if (isMatrix) {
                      // Add Multiple Items
                      final matrix =
                          Map<String, double>.from(jsonDecode(matrixJson));
                      ...
                      final finalItemId = selectedItemId ??
                        ...
                        children: [
                          Expanded(
                            child: TextField(
                              ...
                              decoration:
                                  _inputDecoration("Invoice No", isDark),
                            ),
                          ),
                          const SizedBox(width: 12),
                          Expanded(
