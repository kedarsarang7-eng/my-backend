...
void main() {
              ...
              child: SizedBox(
                ...
                child: ModernCard(
                  ...
                  child: Column(
                    ...
                    children: const [
                      Icon(Icons.star,
                          size: 40, color: FuturisticColors.primary),
                      SizedBox(height: 8),
                      Text('Colored Card'),
                    ],
                  ),
  ...
  group('StatisticWidget Golden Tests',
      skip: !_enableGoldenTests ? _skipReason : null, () {
  ...
  group('FuturisticButton Golden Tests',
      skip: !_enableGoldenTests ? _skipReason : null, () {
  ...
  group('ModernListTile Golden Tests',
      skip: !_enableGoldenTests ? _skipReason : null, () {
  ...
  group('AnimatedTabBar Golden Tests',
      skip: !_enableGoldenTests ? _skipReason : null, () {
  ...
  group('Color Palette Golden Tests',
      skip: !_enableGoldenTests ? _skipReason : null, () {
          ...
          home: Scaffold(
            body: Padding(
              ...
              child: Wrap(
                ...
                children: [
                  _ColorSwatch(
                      color: FuturisticColors.primary, label: 'Primary'),
                  _ColorSwatch(
                      color: FuturisticColors.secondary, label: 'Secondary'),
                  _ColorSwatch(color: FuturisticColors.accent, label: 'Accent'),
                  _ColorSwatch(
                      color: FuturisticColors.success, label: 'Success'),
                  _ColorSwatch(
                      color: FuturisticColors.warning, label: 'Warning'),
                  _ColorSwatch(color: FuturisticColors.error, label: 'Error'),
                  _ColorSwatch(color: FuturisticColors.accent2, label: 'Info'),
                ],
              ),
            ),
          ),
  ...
  group('Dashboard Card Grid Golden Tests',
      skip: !_enableGoldenTests ? _skipReason : null, () {
